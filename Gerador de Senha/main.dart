...
main(){
  ...
  pass = "${listPass[0]}${listPass[1]}${listPass[2]}${listPass[3]}${listPass[4]}${listPass[5]}${listPass[6]}${listPass[7]}${listPass[8]}${listPass[9]}${listPass[10]}${listPass[11]}${listPass[12]}${listPass[13]}${listPass[14]}${listPass[15]}";
  print(pass.toUpperCase());
